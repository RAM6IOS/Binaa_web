        ...
        <div className="space-y-6 flex-1 overflow-y-auto py-2">
          ...
          {isParsing && (
            <div className="py-12 flex flex-col items-center justify-center space-y-3">
              ...
              <p className="text-sm font-bold text-muted-foreground">{isAr ? 'جاري قراءة وتحليل بنود العقد بالذكاء الاصطناعي...' : 'Analyse des données par IA en cours...'}</p>
            </div>
          )}
                  ...
                  <TableBody className="text-xs">
                    {rows.map((row) => (
                      ...
                      >
                        ...
                        <TableCell className="font-medium truncate max-w-40">{row.designation || '-'}</TableCell>
